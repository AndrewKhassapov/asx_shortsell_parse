...
public class Program
{
	...
	const string fetchURL = "https://www.asx.com.au/data/shortsell.txt";
	...
	protected static string ParseHTML(){
		...
		string[] parsedHTML = htmlBody.Split('\n');

		foreach(string i in parsedHTML){
			Console.WriteLine(i + "\n");
		}
	...
	// Get the response.
	HttpResponseMessage response = await client.PostAsync(fetchURL, requestContent);
